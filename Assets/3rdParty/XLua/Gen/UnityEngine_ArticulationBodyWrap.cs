    ...
    public class UnityEngineArticulationBodyWrap 
    {
        ...
        static int _g_get_jointType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ArticulationBody gen_to_be_invoked = (UnityEngine.ArticulationBody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineArticulationJointType(L, gen_to_be_invoked.jointType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_linearLockX(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ArticulationBody gen_to_be_invoked = (UnityEngine.ArticulationBody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineArticulationDofLock(L, gen_to_be_invoked.linearLockX);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_linearLockY(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ArticulationBody gen_to_be_invoked = (UnityEngine.ArticulationBody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineArticulationDofLock(L, gen_to_be_invoked.linearLockY);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_linearLockZ(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ArticulationBody gen_to_be_invoked = (UnityEngine.ArticulationBody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineArticulationDofLock(L, gen_to_be_invoked.linearLockZ);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_swingYLock(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ArticulationBody gen_to_be_invoked = (UnityEngine.ArticulationBody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineArticulationDofLock(L, gen_to_be_invoked.swingYLock);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_swingZLock(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ArticulationBody gen_to_be_invoked = (UnityEngine.ArticulationBody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineArticulationDofLock(L, gen_to_be_invoked.swingZLock);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_twistLock(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ArticulationBody gen_to_be_invoked = (UnityEngine.ArticulationBody)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineArticulationDofLock(L, gen_to_be_invoked.twistLock);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
