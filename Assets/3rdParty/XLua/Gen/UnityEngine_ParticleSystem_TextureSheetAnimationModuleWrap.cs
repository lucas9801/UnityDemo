    ...
    public class UnityEngineParticleSystemTextureSheetAnimationModuleWrap 
    {
        ...
        static int _g_get_mode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TextureSheetAnimationModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemAnimationMode(L, gen_to_be_invoked.mode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_timeMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TextureSheetAnimationModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemAnimationTimeMode(L, gen_to_be_invoked.timeMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_animation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TextureSheetAnimationModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemAnimationType(L, gen_to_be_invoked.animation);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_rowMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TextureSheetAnimationModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemAnimationRowMode(L, gen_to_be_invoked.rowMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
