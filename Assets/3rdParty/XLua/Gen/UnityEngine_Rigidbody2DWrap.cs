    ...
    public class UnityEngineRigidbody2DWrap 
    {
        ...
        static int _g_get_constraints(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Rigidbody2D gen_to_be_invoked = (UnityEngine.Rigidbody2D)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineRigidbodyConstraints2D(L, gen_to_be_invoked.constraints);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_interpolation(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Rigidbody2D gen_to_be_invoked = (UnityEngine.Rigidbody2D)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineRigidbodyInterpolation2D(L, gen_to_be_invoked.interpolation);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_sleepMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Rigidbody2D gen_to_be_invoked = (UnityEngine.Rigidbody2D)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineRigidbodySleepMode2D(L, gen_to_be_invoked.sleepMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_collisionDetectionMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Rigidbody2D gen_to_be_invoked = (UnityEngine.Rigidbody2D)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineCollisionDetectionMode2D(L, gen_to_be_invoked.collisionDetectionMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
