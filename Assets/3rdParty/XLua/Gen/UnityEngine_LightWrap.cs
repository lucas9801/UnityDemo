    ...
    public class UnityEngineLightWrap 
    {
        ...
        static int _g_get_shape(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightShape(L, gen_to_be_invoked.shape);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_lightShadowCasterMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightShadowCasterMode(L, gen_to_be_invoked.lightShadowCasterMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_renderMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightRenderMode(L, gen_to_be_invoked.renderMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
