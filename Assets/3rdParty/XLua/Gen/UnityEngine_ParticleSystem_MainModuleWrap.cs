    ...
    public class UnityEngineParticleSystemMainModuleWrap 
    {
        ...
        static int _g_get_simulationSpace(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemSimulationSpace(L, gen_to_be_invoked.simulationSpace);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_scalingMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemScalingMode(L, gen_to_be_invoked.scalingMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_emitterVelocityMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemEmitterVelocityMode(L, gen_to_be_invoked.emitterVelocityMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_stopAction(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemStopAction(L, gen_to_be_invoked.stopAction);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_ringBufferMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemRingBufferMode(L, gen_to_be_invoked.ringBufferMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_cullingMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.MainModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemCullingMode(L, gen_to_be_invoked.cullingMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
