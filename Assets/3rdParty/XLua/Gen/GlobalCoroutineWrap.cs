...
namespace XLua.CSObjectWrap
{
    ...
    public class GlobalCoroutineWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(GlobalCoroutine);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "NoGCRunCoroutine", _m_NoGCRunCoroutine_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new GlobalCoroutine();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to GlobalCoroutine constructor!");
		    ...
		    try {
                ...
                
                {
                    System.Collections.IEnumerator _routine = (System.Collections.IEnumerator)translator.GetObject(L, 1, typeof(System.Collections.IEnumerator));
                        ...
                        var gen_ret = GlobalCoroutine.StartCoroutine( _routine );
                        translator.Push(L, gen_ret);
        ...
        static int _m_StopCoroutine_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    GlobalCoroutine.StopCoroutine( _routine );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_NoGCRunCoroutine_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    System.Collections.IEnumerator _routine = (System.Collections.IEnumerator)translator.GetObject(L, 1, typeof(System.Collections.IEnumerator));
                        ...
                        var gen_ret = GlobalCoroutine.NoGCRunCoroutine( _routine );
                        translator.Push(L, gen_ret);
