    ...
    public class UnityEngineParticleSystemTriggerModuleWrap 
    {
        ...
        static int _g_get_inside(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TriggerModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemOverlapAction(L, gen_to_be_invoked.inside);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_outside(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TriggerModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemOverlapAction(L, gen_to_be_invoked.outside);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_enter(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TriggerModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemOverlapAction(L, gen_to_be_invoked.enter);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_exit(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TriggerModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemOverlapAction(L, gen_to_be_invoked.exit);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_colliderQueryMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.TriggerModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemColliderQueryMode(L, gen_to_be_invoked.colliderQueryMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
