    ...
    public class UnityEngineParticleSystemCollisionModuleWrap 
    {
        ...
        static int _g_get_type(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.CollisionModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemCollisionType(L, gen_to_be_invoked.type);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_mode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.CollisionModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemCollisionMode(L, gen_to_be_invoked.mode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_quality(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.CollisionModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemCollisionQuality(L, gen_to_be_invoked.quality);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
