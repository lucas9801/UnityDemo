    ...
    public class UnityEngineLightProbeProxyVolumeWrap 
    {
        ...
        static int _g_get_boundingBoxMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.LightProbeProxyVolume gen_to_be_invoked = (UnityEngine.LightProbeProxyVolume)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightProbeProxyVolumeBoundingBoxMode(L, gen_to_be_invoked.boundingBoxMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_resolutionMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.LightProbeProxyVolume gen_to_be_invoked = (UnityEngine.LightProbeProxyVolume)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightProbeProxyVolumeResolutionMode(L, gen_to_be_invoked.resolutionMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_probePositionMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.LightProbeProxyVolume gen_to_be_invoked = (UnityEngine.LightProbeProxyVolume)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightProbeProxyVolumeProbePositionMode(L, gen_to_be_invoked.probePositionMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_refreshMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.LightProbeProxyVolume gen_to_be_invoked = (UnityEngine.LightProbeProxyVolume)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightProbeProxyVolumeRefreshMode(L, gen_to_be_invoked.refreshMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_qualityMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.LightProbeProxyVolume gen_to_be_invoked = (UnityEngine.LightProbeProxyVolume)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightProbeProxyVolumeQualityMode(L, gen_to_be_invoked.qualityMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_dataFormat(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.LightProbeProxyVolume gen_to_be_invoked = (UnityEngine.LightProbeProxyVolume)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineLightProbeProxyVolumeDataFormat(L, gen_to_be_invoked.dataFormat);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
