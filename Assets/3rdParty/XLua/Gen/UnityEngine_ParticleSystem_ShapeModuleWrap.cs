    ...
    public class UnityEngineParticleSystemShapeModuleWrap 
    {
        ...
        static int _g_get_shapeType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.ShapeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemShapeType(L, gen_to_be_invoked.shapeType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_radiusMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.ShapeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemShapeMultiModeValue(L, gen_to_be_invoked.radiusMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_meshShapeType(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.ShapeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemMeshShapeType(L, gen_to_be_invoked.meshShapeType);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_meshSpawnMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.ShapeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemShapeMultiModeValue(L, gen_to_be_invoked.meshSpawnMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_arcMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.ShapeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemShapeMultiModeValue(L, gen_to_be_invoked.arcMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_textureClipChannel(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystem.ShapeModule gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
                translator.PushUnityEngineParticleSystemShapeTextureChannel(L, gen_to_be_invoked.textureClipChannel);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
