    ...
    public class UnityEngineMeshWrap 
    {
        ...
        static int _g_get_vertexBufferTarget(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Mesh gen_to_be_invoked = (UnityEngine.Mesh)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineGraphicsBufferTarget(L, gen_to_be_invoked.vertexBufferTarget);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_indexBufferTarget(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Mesh gen_to_be_invoked = (UnityEngine.Mesh)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineGraphicsBufferTarget(L, gen_to_be_invoked.indexBufferTarget);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
