    ...
    public class UnityEngineParticleSystemRendererWrap 
    {
        ...
        static int _g_get_alignment(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystemRenderer gen_to_be_invoked = (UnityEngine.ParticleSystemRenderer)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineParticleSystemRenderSpace(L, gen_to_be_invoked.alignment);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_renderMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystemRenderer gen_to_be_invoked = (UnityEngine.ParticleSystemRenderer)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineParticleSystemRenderMode(L, gen_to_be_invoked.renderMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_meshDistribution(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystemRenderer gen_to_be_invoked = (UnityEngine.ParticleSystemRenderer)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineParticleSystemMeshDistribution(L, gen_to_be_invoked.meshDistribution);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_sortMode(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.ParticleSystemRenderer gen_to_be_invoked = (UnityEngine.ParticleSystemRenderer)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineParticleSystemSortMode(L, gen_to_be_invoked.sortMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
