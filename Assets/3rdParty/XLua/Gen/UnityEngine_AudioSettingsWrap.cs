...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAudioSettingsWrap 
    {
        ...
        static int _g_get_driverCapabilities(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushUnityEngineAudioSpeakerMode(L, UnityEngine.AudioSettings.driverCapabilities);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_speakerMode(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushUnityEngineAudioSpeakerMode(L, UnityEngine.AudioSettings.speakerMode);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
